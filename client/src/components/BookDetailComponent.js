...
const RenderBook = ({ book }) => {
  ...
  if (book != null) {
    let str = book.volumeInfo.description
    ...
    return (
      <Card key={book.id}>
        ...
        <CardBody>
          ...
          <CardSubtitle>
            <div className="font-weight-bold mt-2">Publisher :</div>
            {book.volumeInfo.publisher
              ? book.volumeInfo.publisher
              : "No publisher Found"}
          </CardSubtitle>
          <CardSubtitle>
            <div className="font-weight-bold mt-2">Categories :</div>
            {book.volumeInfo.categories
              ? book.volumeInfo.categories
              : "No category found"}
          </CardSubtitle>
          <CardSubtitle>
            <div className="font-weight-bold mt-2">Authors :</div>
